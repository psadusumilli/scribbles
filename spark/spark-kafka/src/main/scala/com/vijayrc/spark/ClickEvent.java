...
public class ClickEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ClickEvent\",\"namespace\":\"com.vijayrc.spark\",\"doc\":\"Contains the user id and the product that the user clicked\",\"fields\":[{\"name\":\"userId\",\"type\":\"int\"},{\"name\":\"productId\",\"type\":\"int\"}]}");
  ...
  public static com.vijayrc.spark.ClickEvent.Builder newBuilder() {
    return new com.vijayrc.spark.ClickEvent.Builder();
  }
  
  /** Creates a new ClickEvent RecordBuilder by copying an existing Builder */
  public static com.vijayrc.spark.ClickEvent.Builder newBuilder(com.vijayrc.spark.ClickEvent.Builder other) {
    return new com.vijayrc.spark.ClickEvent.Builder(other);
  }
  
  /** Creates a new ClickEvent RecordBuilder by copying an existing ClickEvent instance */
  public static com.vijayrc.spark.ClickEvent.Builder newBuilder(com.vijayrc.spark.ClickEvent other) {
    return new com.vijayrc.spark.ClickEvent.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ClickEvent>
    ...
    private Builder() {
      super(com.vijayrc.spark.ClickEvent.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.vijayrc.spark.ClickEvent.Builder other) {
      super(other);
    ...
    private Builder(com.vijayrc.spark.ClickEvent other) {
            super(com.vijayrc.spark.ClickEvent.SCHEMA$);
      if (isValidValue(fields()[0], other.userId)) {
        this.userId = data().deepCopy(fields()[0].schema(), other.userId);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'userId' field */
    public com.vijayrc.spark.ClickEvent.Builder setUserId(int value) {
    ...
    public com.vijayrc.spark.ClickEvent.Builder clearUserId() {
    ...
    /** Sets the value of the 'productId' field */
    public com.vijayrc.spark.ClickEvent.Builder setProductId(int value) {
    ...
    public com.vijayrc.spark.ClickEvent.Builder clearProductId() {
