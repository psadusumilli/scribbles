...
public class FileTests {
    ...
    @Test
    public void shouldTransferFileContents() throws Exception {
        RandomAccessFile fromFile = new RandomAccessFile(resource("/samples/1.txt"), "rw");
        FileChannel fromChannel = fromFile.getChannel();
        RandomAccessFile toFile = new RandomAccessFile(fromBaseDir("2.txt"), "rw");
